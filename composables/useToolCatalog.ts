...
export function useToolCatalog() {
  const allTools: ToolInfo[] = [
    ...
    {
      key: 'crop-image',
      titleKey: 'tools.cropImage.title',
      descriptionKey: 'tools.cropImage.description',
      cardDescriptionKey: 'tools.cropImage.card',
      href: '/crop-image',
      icon: 'crop',
      category: 'image',
      accept: 'image/jpeg,image/png,image/webp',
      ...
      maxFiles: 1,
      maxFileSize: imageMaxSize,
      actionKey: 'tools.cropImage.action',
      seoTitleKey: 'seo.cropImageTitle',
      seoDescriptionKey: 'seo.cropImageDescription'
    },
    {
      key: 'rotate-image',
      titleKey: 'tools.rotateImage.title',
      descriptionKey: 'tools.rotateImage.description',
      cardDescriptionKey: 'tools.rotateImage.card',
      href: '/rotate-image',
      icon: 'rotate',
      category: 'image',
      accept: 'image/jpeg,image/png,image/webp',
      ...
      maxFiles: 20,
      maxFileSize: imageMaxSize,
      actionKey: 'tools.rotateImage.action',
      seoTitleKey: 'seo.rotateImageTitle',
      seoDescriptionKey: 'seo.rotateImageDescription'
    },
    {
      key: 'merge-pdf',
    ...
    },
    {
      ...
      cardDescriptionKey: 'tools.compressPdf.card',
      href: '/compress-pdf',
      icon: 'compress-pdf',
      category: 'pdf',
      accept: 'application/pdf',
      ...
      maxFiles: 1,
      maxFileSize: pdfMaxSize,
      actionKey: 'tools.compressPdf.action',
      seoTitleKey: 'seo.compressPdfTitle',
      seoDescriptionKey: 'seo.compressPdfDescription'
    },
    {
      key: 'pdf-to-images',
      titleKey: 'tools.pdfToImages.title',
      descriptionKey: 'tools.pdfToImages.description',
      cardDescriptionKey: 'tools.pdfToImages.card',
      href: '/pdf-to-images',
      icon: 'pdf-images',
      category: 'pdf',
      accept: 'application/pdf',
      ...
      maxFiles: 1,
      maxFileSize: pdfMaxSize,
      actionKey: 'tools.pdfToImages.action',
      seoTitleKey: 'seo.pdfToImagesTitle',
      seoDescriptionKey: 'seo.pdfToImagesDescription'
    },
    {
      key: 'resize-image',
